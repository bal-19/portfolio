...
## Corpus Check
- 55 files · ~13,764 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 352 nodes · 322 edges · 55 communities (35 shown, 20 thin omitted)
...
Cohesion: 0.29
Nodes (4): buildWeeks(), ContributionWeek, MonthLabel, weekdayOf()
...
## Knowledge Gaps
- **197 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `prettier-plugin-tailwindcss` (+192 more)
